...
export const useMutationAtom = <Parameters, Success, Failure>(
  factory: EnsMutationAtomFactory<Parameters, Success, Failure>,
  ...
  const atom = useMemo(() => factory(sdk), [factory, sdk]);
...
export const makeMutationHook =
  ...
  (options: EnsMutationOptions<Parameters, Success, Failure> = {}) =>
    useMutationAtom(factory, options);
