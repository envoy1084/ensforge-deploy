...
/** Exact functions from the pinned Sepolia deployment artifacts. */
export const standaloneHcaV2ManagementAbi = [
  {
    inputs: [],
    name: "addDeposit",
    outputs: [],
...
export const standaloneHcaV2AccountReadsAbi = [
  {
    inputs: [
      {
...
export const hcaUpgradeGateV2ManagementAbi = [
  {
    inputs: [
      {
        internalType: "address",
...
export const trustedHcaSetV2ManagementAbi = [
  {
    inputs: [
      {
        internalType: "address",
