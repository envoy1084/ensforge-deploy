...
const result = await startHcaRegistration(config, {
...
```ts
type StartHcaRegistrationResult = Awaited<ReturnType<typeof startHcaRegistration>>;
```
...
const program = startHcaRegistration.effect(config, {
  hca: "0x1234567890123456789012345678901234567890",
  name: "example.eth",
  duration: 31_536_000n,
  resolver: "0x3456789012345678901234567890123456789012",
