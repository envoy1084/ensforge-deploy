...
```sh [pnpm]
pnpm add @ensforge/hca @ensforge/sdk effect@rc viem
```

```sh [npm]
npm install @ensforge/hca @ensforge/sdk effect@rc viem
```

```sh [yarn]
yarn add @ensforge/hca @ensforge/sdk effect@rc viem
```

```sh [bun]
bun add @ensforge/hca @ensforge/sdk effect@rc viem
```
...
See [compatibility](/hca/compatibility) for the pinned deployment and tested dependency baseline.
